'use strict';
// Banque de la République d'Haïti exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/brh';
...
/** Latest rate for one pair, e.g. getRate('USD', 'HTG', { apiKey }). */
